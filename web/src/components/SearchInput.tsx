...
export function SearchInput() {
  ...
  return (
    <div className="flex items-center z-10">
      ...
      >
        <Menu.Items className="absolute left-0 mt-2 w-28 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
